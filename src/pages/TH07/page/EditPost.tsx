...
const EditPost: React.FC<EditPostProps> = ({ post, onBack, onSave }) => {
  ...
  const handleSubmit = async (values: any) => {
    setLoading(true);
    try {
      const updatedPost = postsService.updatePost(post.id, {
        title: values.title,
        slug: values.slug,
  ...
  return (
    <div className={styles.editPost}>
      ...
      <Card className={styles.card} title={`Chỉnh sửa: ${post.title}`}>
        <Form
          form={form}
          layout="vertical"
